...
var angular = new Framework({
  ...
  npm: "",
  cdn: "Insert the script tag in your header: \ <script src='https://ajax.googleapis.com/ajax/libs/angularjs/1.5.6/angular.min.js'></script>",
  bower: "",
...
var vue = new Framework({
  ...
  cdn: "Insert the script tag in your header:  \ <script src='https://unpkg.com/vue'></script>",
  bower: "",
