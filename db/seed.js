...
var angular = new Framework({
  ...
  npm: "",
  cdn: "Script tag for header: <script src='https://ajax.googleapis.com/ajax/libs/angularjs/1.5.6/angular.min.js'></script>",
  bower: "",
...
var vue = new Framework({
  ...
  cdn: "Script tag for header: <script src='https://unpkg.com/vue'></script>",
  bower: "",
...
var backbone = new Framework({
  ...
  title: "Backbone.js",
  notable: "Backbone is structured so that the applications's data and views are completely decoupled. Backbone's Model functionality watches for changes in the data and notifies the rest of the application when a change occurs. Some large companies that use Backbone include Sony Entertainment, Goje, Zen Payroll and Stitcher.",
  summary: "Backbone is a considered to be a less opinionated JavaScript library that provides flexible ways to query, manipulate and  update data from the server. It's a lightweight library that requires only one dependency (Underscore.js).",
  language: "JavaScript Library",
  ...
  cdn: "Script tag for header: <script type = 'text/javascript' src = 'https://ajax.cdnjs.com/ajax/libs/backbone.js/0.3.3/backbone-min.js'></script>",
  bower: "",
